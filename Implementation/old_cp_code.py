...
#
# Usage (PowerShell):
#   python cp_fault_diagnosis_complete.py --dataset_name "3bar" --data_dir "F:\CP Data\3 bar" --results_dir "F:\Faisal Work\CP Work\Results" --img_size 256 --epochs 40 --tta 8
...
def make_loaders(data_dir, img_size=256, batch_size=32, num_workers=0, seed=42, grayscale=False, weak_aug=False):
...
# ---------------------------
def main():
    ap = argparse.ArgumentParser(description="CP Fault Diagnosis - Complete Pipeline")
